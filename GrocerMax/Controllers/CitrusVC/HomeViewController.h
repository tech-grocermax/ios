...
typedef void (^NewCitrusWalletWalletPaymentHandler)(BOOL isPayMentSuccess);

@interface HomeViewController : BaseViewController


@property (nonatomic, strong) NewCitrusWalletWalletPaymentHandler citrusWalletWalletPaymentHandler;
