...
- (void)closeDrawerAnimated:(BOOL)animated velocity:(CGFloat)velocity animationOptions:(UIViewAnimationOptions)options completion:(void (^)(BOOL finished))completion {
    ...
    if ([[UIDevice currentDevice].systemVersion floatValue] >= 7.0) {
        [UIView animateWithDuration:0.8 delay:0.0 usingSpringWithDamping:damping initialSpringVelocity:velocity options:UIViewAnimationOptionAllowAnimatedContent animations:^{
...
//                [self.zoomDrawerView.contentContainerView ]
                
                CATransform3D transform = CATransform3DIdentity;
                transform.m34 = 0.003;
                transform.m22 = 0.8;
                transform = CATransform3DRotate(transform, M_PI_2/4, 0, 0.8, 0);
                self.zoomDrawerView.contentContainerView.layer.transform = transform;
                
//                CATransform3D transform1 = CATransform3DIdentity;
//                transform1.m34 = 1 / 500.0;
//                transform1 =  CATransform3DScale (transform1, 0.7,
//                                                 0.7, 0);
//                self.zoomDrawerView.contentContainerView.layer.transform = transform1;
//                self.zoomDrawerView.contentContainerView.layer.transform = CATransform3DMakeScale(0.7, 0.7, 0.0f);
